                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            <h1>Index Course</h1>
                            <a href="{{ route('course.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus"
                                        ...
                                        <tbody>
                                            @foreach ($courses as $course)
                                                <tr>
                                                    ...
                                                    <td>{{ $course->title }}</td>
                                                    <td>{{ $course->price }}</td>
                                                    <td><img src="{{ asset('uploads/' . $course->img) }}" width="120px"
                                                            height="100px" alt="no"></td>
                                                    <td>
                                                        <a href="{{ route('course.edit', $course->courseID) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('course.show', $course->courseID) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('course.destroy', $course->courseID) }}"
