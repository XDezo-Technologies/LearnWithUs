                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" max="5" min="1" class="form-control"
                                                        id="exampleInputEmail1" aria-describedby="emailHelp" name="star"
                                                        value="{{ $testimonials->star }}">
                                                    @error('star')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" oninput="checkWordCount(this)"
                                                        name='message'>{{ $testimonials->message }}</textarea>
                                                    @error('message')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <img src="/uploads/{{ $testimonials->img }}" width="120px"
