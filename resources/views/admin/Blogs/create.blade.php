                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>Create</h1>
                            <a href="{{ route('blog.index') }}" class="btn btn-primary btn-md "><i class="fa fa-bars"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name='article2'></textarea>
                                                </div>
                                            </div>
