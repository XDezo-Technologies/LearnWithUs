                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>Add</h1>
                            <a href="{{ route('boardsOfDirector.index') }}" class="btn btn-primary btn-md "><i
                                    class="fa fa-bars" aria-hidden="true"></i></a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Home</a></li>
                                <li class="breadcrumb-item active">add-boardsOfDirector</li>
                            </ol>
                        </nav>
                    </div><!-- End Page Title -->
                    <section class="section">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('boardsOfDirector.store') }}" method="POST"
