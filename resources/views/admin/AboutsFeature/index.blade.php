                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('aboutFeature.create') }}" class="btn btn-primary btn-md "><i
                                        ...
                                        <tbody>
                                            @foreach ($aboutFeatures as $aboutFeature)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('aboutFeature.edit', $aboutFeature->id) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('aboutFeature.show', $aboutFeature->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('aboutFeature.destroy', $aboutFeature->id) }}"
