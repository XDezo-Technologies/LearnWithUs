                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('whyChooseUs.create') }}" class="btn btn-primary btn-md "><i
                                        ...
                                        <tbody>
                                            @foreach ($whyChooseUs as $why)
                                                <tr>
                                                    ...
                                                    <td>{{ $why->logo }}</td>
                                                    <td>
                                                        <a href="{{ route('whyChooseUs.edit', $why->id) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('whyChooseUs.show', $why->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('whyChooseUs.destroy', $why->id) }}"
