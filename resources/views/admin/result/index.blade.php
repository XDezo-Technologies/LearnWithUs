                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('result.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus"
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <table
                                        class="table table-striped table-hover overflow-hidden table-bordered table-lg table-responsive-lg">
                                        <thead>
                                            <tr>
                                                <th scope="col">S.N</th>
                                        ...
                                        <tbody>
                                            @foreach ($results as $result)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('result.edit', $result->resultID) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('result.show', $result->resultID) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('result.destroy', $result->resultID) }}"
