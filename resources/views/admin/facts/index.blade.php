                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            <h1>Index Fact</h1>
                            <a href="{{ route('fact.create') }}" class="btn btn-primary btn-md "><i class="fa fa-plus"
                                        ...
                                        <tbody>
                                            @foreach ($facts as $fact)
                                                <tr>
                                                    ...
                                                    <td>{{ $fact->number }}</td>
                                                    <td>
                                                        <a href="{{ route('fact.edit', $fact->id) }}"
                                                            class="btn btn-md btn-primary"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a>
                                                        <a href="{{ route('fact.show', $fact->id) }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form
                                                                            action="{{ route('fact.destroy', $fact->id) }}"
