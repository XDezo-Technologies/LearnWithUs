                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>Show</h1>
                            <a href="{{ route('about.index') }}" class="btn btn-primary btn-md ">Back</a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('about.store', $abouts->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" disabled name='description'>{{ $abouts->description }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
